...
const TUTORING_TITLE = "Math & Computer Science Tutoring";
const TUTORING_DESCRIPTION =
  "Private math and computer science tutoring from Tarun Eswar, a CS and math student at Washington University in St. Louis. Algebra through Calculus III, AP Statistics, AP Computer Science A, and discrete math. First session free.";

export const metadata: Metadata = {
  title: TUTORING_TITLE,
  ...
  openGraph: {
    ...
    title: `${TUTORING_TITLE} | Tarun Eswar`,
    description: TUTORING_DESCRIPTION,
    images: [OG_IMAGE],
  },
  twitter: {
      ...
      <main className="relative mx-auto w-full scroll-my-12 overflow-auto p-4 print:p-12 md:p-16 dark:bg-gray-950">
        <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6 dark:bg-gray-950">
          <div className="flex items-center justify-between">
            <div className="flex-1 space-y-2">
              <Avatar className="mb-8 size-40 sm:hidden">
                <AvatarImage
                  alt="Tarun Eswar"
                  src={RESUME_DATA.tutoringAvatar}
                />
          ...
          <Section>
            ...
            <p className="text-pretty font-mono text-sm text-muted-foreground">
              My work with students in these subjects involves providing support
              with existing coursework or creating a custom, 10-week curriculum.
            </p>
